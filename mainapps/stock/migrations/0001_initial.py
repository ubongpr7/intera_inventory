    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_variant', models.CharField(blank=True, help_text='Barcode to variant of the product', max_length=200, null=True, verbose_name='Product Variant Barcode')),
                ...
                ('inventory_item', models.ForeignKey(blank=True, help_text='Bridging reference to the redesigned inventory item record.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='legacy_stock_items', to='inventory.inventoryitem', verbose_name='Inventory Item')),
