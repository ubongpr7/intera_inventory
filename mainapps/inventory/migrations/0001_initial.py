    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_id', models.BigIntegerField(blank=True, db_index=True, editable=False, null=True)),
                ('created_by', models.CharField(blank=True, editable=False, help_text='User  ID of the creator', max_length=255, null=True, verbose_name='Created By')),
                ('unit', models.CharField(blank=True, max_length=23, null=True)),
                ('unit_name', models.CharField(blank=True, max_length=23, null=True)),
                ...
                ('minimum_stock_level', models.IntegerField(default=0, help_text='Buffer stock for demand/supply fluctuations', verbose_name='Safety Stock')),
                ...
                ('officer_in_charge_user_id', models.BigIntegerField(blank=True, db_index=True, null=True)),
