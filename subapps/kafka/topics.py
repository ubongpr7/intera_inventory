...
INVENTORY_RESERVATION_TOPIC = "inventory.reservation"
INVENTORY_FULFILLMENT_TOPIC = "inventory.fulfillment"
INVENTORY_PURCHASE_PRICE_TOPIC = "inventory.purchase_price"
